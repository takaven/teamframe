      ...
      <section className="mt-14 max-w-3xl space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-4 pt-2">
          {PILOT_MAILTO ? (
            <a
              href={PILOT_MAILTO}
              className="inline-flex items-center justify-center rounded-lg bg-brand-signal px-6 py-3 text-[15px] font-medium text-ink-800 transition hover:bg-[#B4DD00]"
            >
              Request a pilot
            </a>
          ) : null}
          <Link
            ...
            className={
              PILOT_MAILTO
                ...
                : "inline-flex items-center justify-center rounded-lg bg-brand-signal px-6 py-3 text-[15px] font-medium text-ink-800 transition hover:bg-[#B4DD00]"
            }
          >
            Sign in
          </Link>
