...
export async function GET(request: NextRequest) {
  ...
  if (reportName === "headcount") rows = report.active.map((e) => ({ employee: e.full_name, department: e.department, location: e.work_location, employment_type: humanCsvValue(e.employment_type), country: getCountryName(e.country) ?? e.country, start_date: e.start_date }));
