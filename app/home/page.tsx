  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-14">
      ...
      <header className="border-b border-ink-300/60 pb-5">
        ...
        <p className="mt-1 text-[14px] text-ink-500">{isManager ? "Your team decisions and personal tasks in one place." : "Your tasks, documents and time off in one place."}</p>
      </header>
