...
const ALLOWLIST = [
  ...
  },
  {
    ...
    reason: "Platform Owner commits a validated installation setup batch before the customer tenant exists.",
  },
  {
    file: "services/customerProvisioningService.ts",
    table: "companies",
    enclosingFn: "commitSetupPack",
    reason: "Platform Owner provisioning intentionally creates a customer company root record before a tenant scope exists.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owners",
    enclosingFn: "countActivePlatformOwners",
    reason: "Platform Owner identities are platform-scoped and must not be tenant-scoped.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owners",
    enclosingFn: "listPlatformOwnerState",
    reason: "Platform Owner identities are platform-scoped and must not be tenant-scoped.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owner_transfer_requests",
    enclosingFn: "listPlatformOwnerState",
    reason: "Platform Owner handover records are platform-scoped and visible only after Platform Owner authorization.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owner_transfer_requests",
    enclosingFn: "listPendingPlatformOwnerTransfersForActor",
    reason: "Pending Platform Owner handovers are platform-scoped and filtered to the authenticated replacement actor in service code.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owner_transfer_requests",
    enclosingFn: "nominatePlatformOwnerTransfer",
    reason: "Platform Owner handover supersession is platform-scoped and requires Platform Owner authorization.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owner_transfer_requests",
    enclosingFn: "acceptPlatformOwnerTransfer",
    reason: "Platform Owner handover acceptance is platform-scoped and requires matching replacement identity.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owners",
    enclosingFn: "acceptPlatformOwnerTransfer",
    reason: "Accepted Platform Owner identity is platform-scoped and must not create tenant membership.",
  },
  {
    file: "services/platformOwnerService.ts",
    table: "platform_owners",
    enclosingFn: "revokePlatformOwner",
    reason: "Platform Owner revocation is platform-scoped and requires Platform Owner authorization.",
  },
  {
    file: "services/platformService.ts",
    table: "companies",
    enclosingFn: "loadPlatformOverview",
    reason: "Platform Control Room intentionally lists customer companies across tenants after Platform Owner authorization.",
  },
  {
    file: "services/platformService.ts",
    table: "employees",
    enclosingFn: "loadPlatformOverview",
    reason: "Platform Control Room intentionally computes cross-tenant operational counts after Platform Owner authorization.",
  },
  {
    file: "services/platformService.ts",
    table: "tenant_memberships",
    enclosingFn: "loadPlatformOverview",
    reason: "Platform Control Room intentionally computes cross-tenant membership counts after Platform Owner authorization.",
  },
  {
    file: "services/platformService.ts",
    table: "hr_automation_items",
    enclosingFn: "loadPlatformOverview",
    reason: "Platform Control Room intentionally computes cross-tenant failed automation counts after Platform Owner authorization.",
  },
  {
    file: "services/platformService.ts",
    table: "file_operations",
    enclosingFn: "loadPlatformOverview",
    reason: "Platform Control Room intentionally computes cross-tenant failed operation counts after Platform Owner authorization.",
  },
  {
    file: "services/platformService.ts",
    table: "companies",
    enclosingFn: "updateCompanyStatus",
    reason: "Platform Owner company suspension/reactivation operates on company id after Platform Owner authorization.",
  },
];
