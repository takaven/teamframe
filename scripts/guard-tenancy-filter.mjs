...
const ALLOWLIST = [
  ...
  },
  {
    ...
    reason: "Installer commits a validated local installation setup batch before the customer tenant exists.",
  },
  {
    file: "services/customerProvisioningService.ts",
    table: "companies",
    enclosingFn: "commitSetupPack",
    reason: "Installer provisioning intentionally creates a customer company root record before a tenant scope exists.",
  },
];
